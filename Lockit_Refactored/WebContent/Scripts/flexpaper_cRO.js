...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _Key                = (config.key != null ? config.key : "$3eb4364ab4c4961cf0a");
    ...
    window[instance] = flashembed(id, {
        src						    : _jsDirectory+"../FlexPaperViewer_cRO.swf",
        version					    : [10, 0],
...
(function() {
    ...
    function Flash(root, opts, conf) {
        ...
        if(!conf.RenderingOrder && conf.SwfFile !=  null){conf.RenderingOrder = "html5";}
