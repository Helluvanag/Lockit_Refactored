<%@page import="java.util.ArrayList, com.verudix.lockit.flexpaperviewer.Config"%>
<%
		...
		<form method="post" action="index.jsp">
			<div style="float:left;position:absolute;">
				<div style="position:absolute;left:0px;top:0px;">
					<button class="tiny main n_button" type="submit"><span></span><em style="min-width:100px"><img src="../common/images/upload.png" style="padding-top:2px;"/>&nbsp;Upload</em></button>&nbsp;<br/>
				</div>
				<div style="position:absolute;left:0px;top:0px;">
					<input id="file_upload" type="file" name="Filedata" accept="application/pdf"/>
				</div>
			</div>
