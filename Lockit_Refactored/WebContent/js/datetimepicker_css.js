...
var SpanBorderColor = "#2076A5";//span border color
var SpanBgColor = "#FFFFFF"; //span background color
var MonthYearColor = "#4B546A"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#2076A5"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#C4D5DF"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#C4D5DF"; //Background color of Saturday.
var WeekDayColor = "#FFFFFF"; //Background color of weekdays.
var FontColor = "#2076A5"; //color of font in Calendar day cell.
var TodayColor = "#ffbd35"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#EBC2C0"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
