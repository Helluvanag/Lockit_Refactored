...
<%@ page import="com.verudix.lockit.flexpaperviewer.Setup, java.util.ArrayList, com.verudix.lockit.flexpaperviewer.JArray, com.verudix.lockit.flexpaperviewer.MyCon" %>
<%
