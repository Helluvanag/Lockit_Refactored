...
public class MyCon {
    ...
    public String checkConnection(String host, String userName,String password, String dbName){
    ...
    public Connection getConnection(String host, String userName,String password, String dbName){
        try{
			String url = "jdbc:mysql://";
			host = host.trim();
			host = host.replace("http://", "");
