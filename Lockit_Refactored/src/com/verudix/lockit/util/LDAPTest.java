...
public class LDAPTest {
	...
	Logger logger = Logger.getLogger(LDAPTest.class);
    /**
    ...
    public static boolean LDAPAuthenticate(String domainserver,String username,String password){
    	
    	try{
        
	      //  final String ldapAdServer = "ldap://ad.your-server.com:389";
    		final String ldapAdServer = domainserver;
